...
const App = () => {
  ...
  return (
    <div className="container3 w-full max-w-full">
      <motion.nav
        initial="closed"
      ...
      >
       <div className="logo-container">
          <Link to={"/"}>
            <motion.img variants={hideNavItemsVariant} src="/logo.png" className="w-[80px] md:w-[110px] transition-all duration-700" alt="logo" />
          </Link>
        </div>
