...
import question from "../../assets/client/raks/img/question.png"; // ? icon
            ...
            {line.split("").map((char, i) => {
              ...
              return (
                <motion.span
                  key={i}
                  style={{ opacity }}
                  className="text-[#000085] font-bold salo uppercase text-[50px] md:text-[120px] tracking-normal"
                >
                  {char}
                </motion.span>
              );
