      ...
      <div className="w-full max-w-[1440px] 2xl:max-w-[1600px] flex flex-col md:flex-row">
        ...
        >
          ...
          >
            ...
            <span className="salo text-[#000085] text-[18px] md:text-[26px] xl:text-[32px] 2xl:text-[40px]">
              Reggio Emilia philosophy,
            </span>{" "}
            fostering experiential, interdisciplinary learning for children to grow with purpose.
            Embracing this spirit, Haus of Chaos crafted an identity for{" "}
            <span className="salo text-[#000085] text-[18px] md:text-[26px] xl:text-[32px] 2xl:text-[40px]">
              RaK’s Pallikkoodam
            </span>{" "}
            that is warm, attentive, and child-centric.
            The result is a playful yet thoughtful visual language and environment designed to nurture curiosity and lifelong learning.
