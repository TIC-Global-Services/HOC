...
const MobRaksSec7 = () => {
  ...
  return (
    ...
    >
      ...
      {/* ─── TOP TEXT ─── */}
      <div className="max-w-[320px] text-start pt-[20%] relative z-10">
      ...
      {/* ─── CENTER IMAGE ─── */}
      <div className="relative flex justify-center pt-[10%] z-10">
      ...
      {/* ─── BOTTOM HEADING ─── */}
      <div className="flex justify-start self-start pt-[5%] relative z-10">
