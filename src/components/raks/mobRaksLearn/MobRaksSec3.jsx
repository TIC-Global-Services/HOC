...
const topImg = "https://ik.imagekit.io/hoc01/assets/client/raks/panel2.png";
const leftIcon = "https://ik.imagekit.io/hoc01/assets/client/raks/heroImg2.png";
...
const MobRaksSec3 = () => {
  ...
  return (
    <section className="w-full h-screen flex flex-col relative overflow-hidden bg-white">
      ...
      {/* ─── TOP IMAGE ─── */}
      <div className="w-full h-[60%] sm:h-full relative z-10">
      ...
      <div className="w-full h-[40%] flex items-center justify-around relative z-10">
        ...
        <div className="max-w-[240px] text-start">
          <p className="jost text-black text-[16px] sm:text-xl leading-[120%] capitalize">
