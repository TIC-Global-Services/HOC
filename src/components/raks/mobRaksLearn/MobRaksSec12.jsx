...
const MobRaksSec12 = () => {
  return (
    <section
      className="w-full min-h-[60dvh] flex items-center justify-center px-5"
      style={{ backgroundSize: "100vh", backgroundImage: `url(${grid})` }}
    >
      <div className="max-w-[320px] text-start">
        {/* HEADING */}
        <h2 className="salo text-[30px] text-[#000085] uppercase leading-none mb-3">
          The Art of Growing <br /> Minds
        </h2>

        {/* PARAGRAPH */}
        <p className="jost text-[16px] text-black/50 leading-[20px] max-w-[300px]">
