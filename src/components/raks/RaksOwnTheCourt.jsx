...
export default function RaksOwnTheCourt() {
  ...
  return (
    ...
    >
      <h2
        ref={titleRef}
        className="absolute left-[5%] top-[clamp(40px,8vh,90px)] z-10 opacity-0 salo font-medium text-[14px] md:text-[150px] leading-none uppercase text-[#000085]"
      >
