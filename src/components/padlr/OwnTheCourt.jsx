...
export default function OwnTheCourt() {
  ...
  return (
    <section
      ...
      <h2 className="absolute left-[5%] top-[clamp(40px,8vh,90px)] text-start z-10 m-0 salo font-medium text-[clamp(14px,8.3vw,120px)] leading-none tracking-[-0.02em] uppercase text-[#7ac9f0]">
