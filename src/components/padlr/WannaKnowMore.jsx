...
import question from "../../assets/client/padlr/img/questionIcon.png"; // ? icon
            ...
            {line.split("").map((char, i) => {
              ...
              return (
                <motion.span
                  key={i}
                  style={{ opacity }}
                  className="text-[#8FB3D9] font-bold salo uppercase text-[50px] md:text-[120px] tracking-normal"
                >
                  {char}
                </motion.span>
              );
