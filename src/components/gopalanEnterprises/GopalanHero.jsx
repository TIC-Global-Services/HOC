    ...
    <section className="w-full min-h-screen flex justify-center">
      ...
      <div className="w-full max-w-[1440px] 2xl:max-w-[1600px] flex flex-col md:flex-row">
        ...
        >
          <p
            className="
              jost text-start capitalize tracking-tight
              font-[500] 
              text-black 
              max-w-[656px]
              leading-[150%]
          ...
          >
            ...
            trust with a future-ready vision. The refined <span className="text-[40px] font-[400] salo text-[#E96428]">logomark</span>  and evolved
            palette retain architectural roots while introducing a sense of
            dynamism, adaptability, and modernity. Through a modular,
