...
export default function SyedOwnTheCourt() {
  ...
  return (
    ...
    >
      {/* TITLE */}
      <h2 className="absolute left-[5%] top-[clamp(40px,12vh,90px)] z-10 m-0 salo font-medium text-[14px] md:text-[140px] leading-none tracking-[-0.02em] uppercase text-[#262666]">
