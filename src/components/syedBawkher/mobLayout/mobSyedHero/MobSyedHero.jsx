...
const MobSyedHero = () => {
  return (
    <section className="w-full min-h-screen flex flex-col mt-[25%]">
      ...
      >
        {/* STATIC FLOAT IMAGES */}
        <img src={img1} className="absolute top-[20%] left-[10%] w-[100px]" />
        <img src={img2} className="absolute top-[20%] right-[10%] w-[100px]" />
        <img src={img3} className="absolute bottom-[20%] left-[8%] w-[100px]" />
        <img src={img4} className="absolute bottom-[20%] right-[8%] w-[100px]" />
