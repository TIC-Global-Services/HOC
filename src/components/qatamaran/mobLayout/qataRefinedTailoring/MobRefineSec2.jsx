...
const MobRefineSec2 = () => {
  ...
  return (
    <section
      className="w-full h-screen flex flex-col py-[15%]"
      style={{
    ...
    >
      ...
      <div className="flex flex-col justify-center mt-6 px-10 gap-3">
        ...
        <h2 className="salo text-start text-white text-[50px] leading-none">
      ...
      <div
        ...
        data-speed="0.6"
        data-rotate="-12"
        className="w-[90px] self-end mt-6"
      >
      ...
      <div className="flex justify-center mt-8">
        <p className="jost text-start text-white/80 max-w-[320px] text-[16px] leading-[23px] capitalize">
