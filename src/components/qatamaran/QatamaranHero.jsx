  ...
  return (
    <section className="w-full min-h-screen flex justify-center">
      ...
      <div className="w-full flex flex-col md:flex-row relative">
        ...
        >
          ...
          <div className="w-full h-full flex flex-col items-center justify-center gap-4 md:gap-6 px-4">
            <h1
              ...
              style={{ fontSize: "clamp(48px, 12vh, 140px)" }}
            >
              Qatamaran
            </h1>
        ...
        "
        >
          <p className="jost capitalize text-start font-[500] tracking-tight text-black max-w-[420px] lg:max-w-[50px] xl:max-w-[580px] 2xl:max-w-[740px] leading-[160%] text-[14px] md:text-[18px] xl:text-[24px]">
