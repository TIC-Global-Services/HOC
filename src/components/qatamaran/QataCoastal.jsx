  ...
  return (
    ...
    >
      <GridOverlay
          ...
          />
      {/* TITLE */}
      <h2 className="absolute left-[5%] text-start top-[clamp(40px,8vh,90px)] z-10 m-0 salo font-medium text-[14px] lg:text-[140px] leading-none tracking-[-0.02em] uppercase text-[#1E382D]">
